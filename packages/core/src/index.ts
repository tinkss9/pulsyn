...
export { RedisSourceConnector as RedisConnector } from './connectors/redis-source';
export { DynamoDBConnector } from './connectors/dynamodb';
export { KafkaSourceConnector as KafkaConnector } from './connectors/kafka-source';
...
export { AmazonS3Connector as S3Connector } from './connectors/s3';
export { AzureBlobStorageConnector as AzureBlobConnector } from './connectors/azure-blob';
export { GoogleCloudStorageConnector as GCSConnector } from './connectors/gcs';
...
export { WordpressConnector as WordPressConnector } from './connectors/wordpress';
