// @ts-nocheck
// Square for Restaurants Connector — Pulsyn CDC Platform
...
export class SquareRestaurantsConnector extends BaseConnector {
  private apiKey: string = '';
  private baseUrl: string = '';
  private accessToken: string = '';

  constructor(id: string, name: string, config: DatabaseConfig) {
    super(id, name, 'square-restaurants', config);
  }
