...
const TABLE_SCHEMAS: Record<string, { columns: any[]; pk: string }> = {
  RTM_SPP: {
    pk: 'deliveryDate',
    columns: [
      { name: 'deliveryDate', type: 'date', nullable: false, defaultValue: null },
      { name: 'deliveryHour', type: 'integer', nullable: false, defaultValue: null },
      { name: 'deliveryInterval', type: 'integer', nullable: false, defaultValue: null },
      { name: 'settlementPoint', type: 'varchar', nullable: false, defaultValue: null },
      { name: 'settlementPointPrice', type: 'decimal', nullable: false, defaultValue: null },
    ],
  },
  DAM_SPP: {
    pk: 'deliveryDate',
    columns: [
      ...
      { name: 'settlementPoint', type: 'varchar', nullable: false, defaultValue: null },
      { name: 'settlementPointPrice', type: 'decimal', nullable: false, defaultValue: null },
      { name: 'settlementPointType', type: 'varchar', nullable: true, defaultValue: null },
    ],
  },
  GENERATION_MIX: {
    pk: 'timestamp',
    columns: [
      ...
      { name: 'fuelType', type: 'varchar', nullable: false, defaultValue: null },
      { name: 'generation', type: 'decimal', nullable: false, defaultValue: null },
      { name: 'percentage', type: 'decimal', nullable: true, defaultValue: null },
    ],
  },
  SYSTEM_LOAD: {
    pk: 'deliveryDate',
    columns: [
      { name: 'deliveryDate', type: 'date', nullable: false, defaultValue: null },
      { name: 'deliveryHour', type: 'integer', nullable: false, defaultValue: null },
      { name: 'weatherZone', type: 'varchar', nullable: false, defaultValue: null },
      { name: 'systemLoad', type: 'decimal', nullable: false, defaultValue: null },
      { name: 'dstFlag', type: 'boolean', nullable: true, defaultValue: null },
    ],
  },
  WIND_FORECAST: {
    pk: 'deliveryDate',
    columns: [
      { name: 'deliveryDate', type: 'date', nullable: false, defaultValue: null },
      { name: 'deliveryHour', type: 'integer', nullable: false, defaultValue: null },
      { name: 'actual', type: 'decimal', nullable: true, defaultValue: null },
      { name: 'forecast', type: 'decimal', nullable: true, defaultValue: null },
      { name: 'copHse', type: 'decimal', nullable: true, defaultValue: null },
    ],
  },
};
...
export class ErcotConnector extends BaseConnector {
  ...
  async extractFull(table: string): Promise<UnifiedChangeEvent[]> {
    ...
    while (true) {
      ...
      for (const row of rows) {
        ...
        events.push(createEvent('S', table, row, null, pk, { source: 'ercot' }));
      }
  ...
  async extractIncremental(table: string, watermark: string | null): Promise<UnifiedChangeEvent[]> {
    ...
    for (const row of rows) {
      ...
      events.push(createEvent('I', table, row, null, ts, { source: 'ercot' }));
    }
    this.lastWatermark[table] = new Date().toISOString();
    return events;
  }
