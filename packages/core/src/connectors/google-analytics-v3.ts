// @ts-nocheck
// Google Analytics v3 Connector — Pulsyn CDC Platform
...
export class GoogleAnalyticsV3Connector extends BaseConnector {
  ...
  constructor(id: string, name: string, config: DatabaseConfig) {
    super(id, name, 'google-analytics-v3', config);
  }
