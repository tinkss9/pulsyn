// @ts-nocheck
// Prometheus v2 Connector — Auto-generated from config
...
@registerSource('prometheus-v2')
export class Prometheusv2Connector extends SaaSConnector {
  constructor(id: string, config: DatabaseConfig) {
    super(id, 'prometheus-v2', 'prometheus-v2', config, {
